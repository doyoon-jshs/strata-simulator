            ...
            <aside className="grid min-h-0 min-w-0 gap-3 lg:grid-rows-2">
              <Card className="flex min-h-0 flex-col border border-slate-200 bg-white shadow-sm ring-0">
                <CardHeader className="border-b border-slate-100">
                  ...
                  <CardAction><Badge variant="outline" className="border-slate-200 bg-slate-50 font-mono text-[10px] text-slate-500">CLICK ADD · RIGHT-CLICK REMOVE · DRAG X–Y</Badge></CardAction>
                </CardHeader>
